...
public class BoardVo {
	...
	public BoardVo(String title, String name, String content, int hit, String reg_date, int user_no) {
		this.title = title;
		this.name = name;
		this.content = content;
		this.hit = hit;
	...
	public BoardVo(int no, String title, String name, String content, int hit, String reg_date) {
		this.no = no;
		this.title = title;
		this.name = name;
		this.content = content;
